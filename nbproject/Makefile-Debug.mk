...
${OBJECTDIR}/_ext/75798430/ising_kron_general.o: /home/qfeuille/Storage/Programming/Oxford/TP11_1/ising_kron_general.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/75798430/ising_kron_general.o /home/qfeuille/Storage/Programming/Oxford/TP11_1/ising_kron_general.cpp

${OBJECTDIR}/XYZ_dists.o: XYZ_dists.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../.. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XYZ_dists.o XYZ_dists.cpp
