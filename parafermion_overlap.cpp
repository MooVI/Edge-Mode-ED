...
//    std::cout << test << std::endl;
    ...
    auto body = [&](mpreal phi, int i) {
        complex ephi = std::polar(1., phi);
        complex mephi = std::polar(1., -phi);
        complex eth = std::polar(1., phi);
        complex meth = std::polar(1., -phi);
    ...
    pdA.style = "l";
    pdA.input = "parfermion_A_" + std::to_string(width);
    pdB.input = "parfermion_B_" + std::to_string(width);
